  ...
  if (!isLoaded || !isSignedIn) {
    return (
      <div className="min-h-screen">
        <Header />
        <main className="px-4 py-16 text-center text-ink/50">Sign in to view your events.</main>
      </div>
    );
  }
      ...
      <main className="mx-auto max-w-5xl px-4 py-8">
        {created ? (
          <div className="mx-auto max-w-xl space-y-6">
            ...
            <button onClick={() => setCreated(null)} className="btn-outline w-full">
              Back to my events
            </button>
          </div>
        ) : creating ? (
          <div className="mx-auto max-w-xl space-y-4">
            <div className="flex items-center justify-between">
              ...
              <button onClick={() => setCreating(false)} className="text-sm text-ink/50 hover:text-brand">
                Cancel
              </button>
            </div>
